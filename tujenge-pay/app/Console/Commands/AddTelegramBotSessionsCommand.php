...
class AddTelegramBotSessionsCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bot:add-te-sessions';
...
//                            ]
                    ...
                    [
                        ...
                        'responses' => [
                            [
                                ...
                                'key_word' => 1,
                                'show_step_id' => 0,
                                'response_text' => 'Please enter your membership number. *Formatted E.g. KE12345000 or AK12345000*',
                                'next_session_step' => 2
                            ]
                        ]
                    ],
                    [
                        ...
                        'responses' => [
                            [
                                ...
                                'key_word' => 3,
                                'show_step_id' => 0,
                                'response_text' => 'Please reply with your date of birth formatted as *yyyy-mm-dd*',
                                'next_session_step' => 3
                            ]
                        ]
                    ],
            ...
            [
                'session_name' => 'My cover',
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '1. My cover',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
            ...
            [
                'session_name' => '/benefitbalances',
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '2. Benefit balances',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
            ...
            [
                'session_name' => 'Cover utilization',
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '3. Cover utilization',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
                    ...
                    [
                        ...
                        'responses' => [
                            [
                                'channel' => 'TE',
                                'key_word' => 2,
                                'response_text' => '1. Agree and continue',
                                'show_step_id' => 0,
                                'next_session_step' => 24
                            ]
                        ]
            ...
            [
                'session_name' => 'Claims Session',
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '4. Claims',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
            ...
            [
                ...
                'session_steps' => [
                    ...
                    [
                        ...
                        'is_initial_step' => false,
                        'session_step' => 2,
                        'step_title' => "Please reply with your date of birth formatted as *yyyy-mm-dd*",
                        'next_session_step' => 3,
                        'service_methods' => [
                            [
                                'method_name' => 'confirmOtp',
            ...
            [
                ...
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '6. Premium statement',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
            ...
            [
                ...
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '7. Request for quote',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
...
//                            ]
            ...
            [
                ...
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '8. Request for letters',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
            ...
            [
                ...
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '9. Buy insurance product',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
            ...
            [
                ...
                'channel' => 'TE',
                'session_switching' => 1,
                'session_key_word' => '10. Customer care',
                'session_steps' => [
                    [
                        'channel' => 'TE',
                        'is_initial_step' => true,
